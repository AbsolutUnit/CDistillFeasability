...
@dataclass
class ContextDistillArguments():
    """
    Arguments pertaining to what data we are going to input our model for training and eval.
    """

    input_pattern: Optional[str] = field(
        default="{text1} {text2} ?", 
        metadata={
            "help": {
                "Pattern to match input and output to, similar to pbft"
            }
        }
    )
    ...
    balanced: bool = field(
        ...
        metadata={
            "help": (
                "Flag for whether classes should be equally represented"
            )
        },
    )
    ...
    description: Optional[str] = field(
        ...
        metadata={
            "help": {
                "Appended description for context for the task"
            }
        }
    )
    ...
    shuffle: bool = field(
        ...
        metadata={
            "help": (
                "Flag for whether to shuffle the data"
            )
        },
    )

    context_distill: bool = field(
        default = False,
        metadata = {
            "help": "Generic Context Distillation Flag"
        }
    )
    ...
    num_shots: int = field(
        ...
        metadata={
            "help": (
                "Number of demonstrations for few-shot"
            )
        },
    )
    ...
    max_context_len: int = field(
        ...
        metadata={
            "help": (
                "Post-tokenization max length, given contextualized input"
            )
        },
    )
    ...
    shot_idx: Optional[str] = field(
        ...
        metadata={
            "help": {
                "File that contains the shot index for samples used"
            }
        }
    )

    context_targets: Optional[str] = field(
        default=None, 
        metadata={
            "help": {
                "Target tokens to map to, similar to pbft"
            }
        }
    )
    ...
    target_prefix: Optional[str] = field(
        ...
        metadata={
            "help": 
            {
                "Target token prefix for easy identification"
            }
        }
    )
