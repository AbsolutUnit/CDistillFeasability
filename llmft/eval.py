...
def _add_args_to_results(args, results):
    ...
    results["description"] = args.description if args.description is not None else " "
...
def main():
    ...
    context, contex_indices = create_few_shot_context(
        ...
        separate_shots_by=in_context_args.separate_shots_by, description=in_context_args.description,
        target_prefix=in_context_args.target_prefix,
        from_indices=in_context_args.shot_idx, balanced=in_context_args.balanced, shuffle=in_context_args.shuffle,
